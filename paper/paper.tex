...
\begin{algorithm}[H]
	...
	\eIf{L heeft minder elementen dan het aantal vertices van de graaf zelf}{
		\Return False
	}{\Return True}
...
Een andere mogelijkheid is het controleren of een graaf `False Twins' heeft. False twins zijn twee vertices die exact dezelfde buren hebben, maar niet met elkaar verbonden zijn. Als graaf G een paar false twins heeft en graaf H niet, kunnen G en H niet meer isomorf zijn met elkaar. Helaas is het niet gelukt om deze methode binnen de tijd te implementeren, om die reden is hij ook niet gevalideerd in de volgende sectie.
